...
From the directory you run this command line from, the user will be prompted with choices which include placing the optimized image files in the folder `optimized` and store the original images in the folder `originals` and well as the ability to overwrite the original files.
